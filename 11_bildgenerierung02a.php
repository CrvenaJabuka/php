...
function erzeugeQuadratischesBild($pfad,$breite_neu) {
...
erzeugeQuadratischesBild("./images/slide3.jpg",800);
erzeugeQuadratischesBild("./images/slide3.jpg",600);
erzeugeQuadratischesBild("./images/slide3.jpg",400);
?>
<!doctype html>
<html>
<head>
